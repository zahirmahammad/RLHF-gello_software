...
def robosuite_hyperparameters(config):
    ...
    config.experiment.keep_all_videos = True                   # save all videos, instead of only saving those for saved model checkpoints
...
DATASET_TYPES = {
    ...
    "custom": {
        "default_dataset_func": "/home/sj/Downloads",
        "hp": robosuite_hyperparameters,
    },
}

# print( "agdjgasgdjkagskjasgfk", TestUtils.example_dataset_path())
...
def get_config(dataset_type="robosuite", dataset_path=None, output_dir=None, debug=False):
    ...
    if output_dir is None:
        ...
        output_dir = "/home/sj/Downloads/output"
